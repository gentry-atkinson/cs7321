...
namespace GTCommons.Commands
{
    public class CalibrationCommands : Window
    {
                ...
                (
                    ...
                    new Action
                        ...
                        delegate
                            {
                                var args1 = new RoutedEventArgs();
                                args1 = new RoutedEventArgs(AcceptEvent, this);
                                RaiseEvent(args1);
                            }));
        }
        ...
        public static readonly RoutedEvent AcceptEvent = EventManager.RegisterRoutedEvent("AcceptEvent",RoutingStrategy.Bubble,typeof(CalibrationResultEventHandler), typeof(CalibrationCommands));
