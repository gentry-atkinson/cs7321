...
namespace GTCommons.Commands
{
    ...
    {
        public static readonly RoutedEvent VideoDetachEvent = EventManager.RegisterRoutedEvent("DetachEvent",
                                                                                               RoutingStrategy.Bubble,
                                                                                               typeof (
                                                                                                   RoutedEventHandler),
                                                                                               typeof (
                                                                                                   TrackerViewerCommands
                                                                                                   ));

        public static readonly RoutedEvent VideoCloseEvent = EventManager.RegisterRoutedEvent("CloseEvent",
                                                                                              RoutingStrategy.Bubble,
        ...
        public static readonly RoutedEvent TrackBoxShowEvent = EventManager.RegisterRoutedEvent("TrackBoxShowEvent",
                                                                                                RoutingStrategy.Bubble,
                                                                                                typeof (
                                                                                                    RoutedEventHandler),
                                                                                                typeof (
        ...
        public static readonly RoutedEvent TrackBoxHideEvent = EventManager.RegisterRoutedEvent("TrackBoxHideEvent",
                                                                                                RoutingStrategy.Bubble,
                                                                                                typeof (
                                                                                                    RoutedEventHandler),
                                                                                                typeof (
