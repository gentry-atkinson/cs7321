...
namespace GTCommons.Commands
{
    ...
    {
        public static readonly RoutedEvent SettingsEvent = EventManager.RegisterRoutedEvent("SettingsEvent",
                                                                                            RoutingStrategy.Bubble,
                                                                                            typeof (RoutedEventHandler),
                                                                                            typeof (SettingsCommands));

        public static readonly RoutedEvent AutotuneSettingsEvent =
            EventManager.RegisterRoutedEvent("AutotuneSettingsEvent", RoutingStrategy.Bubble,
                                             typeof (RoutedEventHandler), typeof (SettingsCommands));

        public static readonly RoutedEvent CameraSettingsEvent = EventManager.RegisterRoutedEvent(
            "CameraSettingsEvent", RoutingStrategy.Bubble, typeof (RoutedEventHandler), typeof (SettingsCommands));
        ...
        public static readonly RoutedEvent VideoDetachEvent = EventManager.RegisterRoutedEvent("VideoDetachEvent",
                                                                                               RoutingStrategy.Bubble,
                                                                                               typeof (
                                                                                                   RoutedEventHandler),
                                                                                               typeof (SettingsCommands));
        ...
        public static readonly RoutedEvent VisualizationSettingsEvent =
            EventManager.RegisterRoutedEvent("VisualizationSettingsEvent", RoutingStrategy.Bubble,
                                             typeof (RoutedEventHandler), typeof (SettingsCommands));

        public static readonly RoutedEvent HeadtrackerSettingsEvent =
            EventManager.RegisterRoutedEvent("HeadtrackerSettingsEvent", RoutingStrategy.Bubble,
                                             typeof (RoutedEventHandler), typeof (SettingsCommands));

        public static readonly RoutedEvent EyetrackerSettingsEvent =
            EventManager.RegisterRoutedEvent("EyetrackerSettingsEvent", RoutingStrategy.Bubble,
                                             typeof (RoutedEventHandler), typeof (SettingsCommands));
