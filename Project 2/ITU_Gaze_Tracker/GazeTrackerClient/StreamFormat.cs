namespace GazeTrackerClient
{
    public class StreamFormat
    {
        ...
        public const string StrPupilDiameterX = "%DX";
        public const string StrPupilDiameterY = "%DY";
        ...
        public void Parse(string formatStr)
        {
            ...
            switch (cmd[0])
            {
                ...
                case StrPupilDiameterX:
                    pupilDiameter = true;
                    break;

                case StrPupilDiameterY:
                    pupilDiameter = true;
                    break;
        ...
        public string GetFormatString()
        {
            ...
            if (pupilDiameter)
                format += " " + StrPupilDiameterX + " " + StrPupilDiameterY;
