...
namespace GazeTrackingLibrary.Calibration
{
    ...
    public class CalibrationTarget
    {
		...
		public bool IsCorner
		{
			...
			{
				bool isCorner = false;
				if (GTSettings.Current.Calibration.NumberOfPoints == 9 &&
					(targetNumber == 1 || targetNumber == 3 || targetNumber == 9 || targetNumber == 7))
				{
					isCorner =  true;
				}
				if (GTSettings.Current.Calibration.NumberOfPoints == 12 &&
					(targetNumber == 1 || targetNumber == 4 || targetNumber == 12 || targetNumber == 9))
				{
					isCorner = true;
				}
				if (GTSettings.Current.Calibration.NumberOfPoints == 16 &&
