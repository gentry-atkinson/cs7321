...
namespace GazeTrackingLibrary.Logging
{
    /// <summary>
    ...
    public class Logger
    {
        ...
        public void WriteLine(string line)
        {
            ...
            if (logWriter == null)
            {
                if (logFilePath == null)
                {
                    fs =
                        new FileStream(
                            Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\gazeLog.txt",
                            FileMode.Create);
                }
                else
                {
        ...
        /// </summary>
        /// <param name="imgCounter">The current frame number</param>
        /// <param name="time">The frame time.</param>
        /// <param name="gazeX">The x coordinate of the current gaze position.</param>
        /// <param name="gazeY">The y coordinate of the current gaze position.</param>
