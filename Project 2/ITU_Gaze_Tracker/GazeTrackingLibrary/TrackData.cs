...
namespace GazeTrackingLibrary
{
    public class TrackData
    {
		...
		private GazeTrackingLibrary.EyeMovement.Classifier.EyeMovementStateEnum eyeMovement;
        ...
        public PupilData PupilDataLeft
        {
            ...
            set
            {
                ...
                if(pupilDataLeft.Blob != null && pupilDataLeft.Blob.Area != 0)
                    this.pupilLeftDetected = true;
                else
                    this.pupilLeftDetected = false;
            }
        }
        ...
        public PupilData PupilDataRight
        {
            ...
            set
            {
                ...
                if(pupilDataRight.Blob != null && pupilDataRight.Blob.Area != 0)
                    this.pupilRightDetected = true;
                else
                    this.pupilRightDetected = false;
            }
        }
		...
		public GazeTrackingLibrary.EyeMovement.Classifier.EyeMovementStateEnum EyeMovement
        {
