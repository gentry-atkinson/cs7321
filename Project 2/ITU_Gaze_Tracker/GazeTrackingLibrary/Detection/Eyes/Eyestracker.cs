...
namespace GazeTrackingLibrary.Detection.Eyes
{
    public class EyesTracker
    {
        ...
        public EyesTracker()
        {
            ...
            try
            {
                GTSettings.Current.Eyestracker.OnHaarCascadeLoaded += EyestrackerSettings_OnHaarCascadeLoaded;

                if (GTSettings.Current.Eyestracker.HaarCascade == null)
                    GTSettings.Current.Eyestracker.LoadHaarCascade(EyestrackerSettings.defaultHaarCascade);
            }
            catch (Exception ex)
            {
        ...
        private bool DoEyesRegionExtraction(Image<Gray, Byte> input, TrackData trackData)
        {
            ...
            MCvAvgComp[][] facesDetected = input.DetectHaarCascade(
                GTSettings.Current.Eyestracker.HaarCascade,
                GTSettings.Current.Eyestracker.ScaleFactor,
                2, //Min. neighbours, higher value reduces false detection
                HAAR_DETECTION_TYPE.FIND_BIGGEST_OBJECT,
                GTSettings.Current.Eyestracker.SizeMin);
        ...
        public Rectangle GetEstimatedEyeROI()
        {
            ...
            //Rectangle eyes = this.currentROI;
