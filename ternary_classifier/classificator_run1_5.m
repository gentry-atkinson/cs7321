...
% toggled on
    ...
    if(MODEL_SETTINGS.USE.PURSUITS ~= 0)
        model_count=model_count+1;
% Read parameters
        MODEL_SETTINGS.PURSUITS.K = str2double( get(findobj('Tag','Field1'),'String') );
        MODEL_SETTINGS.PURSUITS.OUT_WIN = str2double( get(findobj('Tag','Field2'),'String') );
% Check parameters
...
% selections
    if(local_error == 0)
        ...
        if( MODEL_SETTINGS.USE.PURSUITS ~= 0)
            ...
            classificator{3}.k = MODEL_SETTINGS.PURSUITS.K;
            used(3) = 1;
            method_str{3} = '_pursuits';
% Insert your fields here
           classificator{3}.k = MODEL_SETTINGS.PURSUITS.K;
           classificator{3}.outlier_window = MODEL_SETTINGS.PURSUITS.OUT_WIN;
%           .................................................
%
        end
